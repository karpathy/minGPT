...
class GPT(nn.Module):
    ...
    def configure_optimizers(self, train_config):
        ...
        decay = set()
        no_decay = set() 
        passlist_weight_modules = (torch.nn.Linear, )
        ...
        for mn, m in self.named_modules():
            for pn, p in m.named_parameters():
                ...
                if pn.endswith('bias'):
                    ...
                    no_decay.add(fpn)
                elif pn.endswith('weight') and isinstance(m, passlist_weight_modules):
                    # weights of passlist modules will be weight decayed
                    decay.add(fpn)
